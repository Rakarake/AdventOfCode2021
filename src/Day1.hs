...
increased :: Int -> Int -> Int
increased x y | x > y = 1 | otherwise = 0


---- ( Part B) ----
nThreeMeasureIncrease :: [Int] -> Int
nThreeMeasureIncrease = nDepthIncrease . partitionSums

partitionSums :: [Int] -> [Int]
partitionSums (x:y:z:xs) = (x + y + z) : partitionSums (y:z:xs)
partitionSums _          = []
